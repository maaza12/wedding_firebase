...
import 'package:laptopfyp/women_side_screens/service_details.dart';
                                                        ...
                                                        content: SizedBox(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Text(
                                                                "Full Name: ${userData['username'] ?? 'Not specified'}",
                                                                style:
                                                                    const TextStyle(
                                                                        fontSize:
                                                                            16),
                                                              ...
                                                              Text(
                                                                "Phone Number: ${userData['mobile_num'] ?? 'Not specified'}",
                                                                style:
                                                                    const TextStyle(
                                                                        fontSize:
                                                                            16),
