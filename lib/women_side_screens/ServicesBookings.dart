...
class SerivcesBooking extends StatefulWidget {
  String postCreatorId = "";

   SerivcesBooking({super.key,required this.postCreatorId});

  @override
  State<SerivcesBooking> createState() => _SerivcesBookingState();
}

class _SerivcesBookingState extends State<SerivcesBooking> {
  String? selection1;
  String? selection2;
  ...
  void _submitForm() async {
    ...
    try {
      ...
      FirebaseFirestore.instance.collection('ServicesBooking').add({
