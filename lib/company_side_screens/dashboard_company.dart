...
class DashboardCompany extends StatelessWidget {
  ...
  void navigateToJobPost(BuildContext context) {
    Navigator.push(
      context,
  ...
  void navigateToMyAds(BuildContext context) {
    Navigator.push(
      context,
  ...
  void navigateToWomenForms(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => WomenForms()),
    );
  }
                      ...
                      children: [
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            height: 120,
                            child: GestureDetector(
                              onTap: () => navigateToJobPost(context),
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Colors.white,
                                  borderRadius: BorderRadius.circular(10),
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            height: 120,
                            child: GestureDetector(
                              onTap: () => navigateToWomenForms(context),
                              child: Container(
                                decoration: BoxDecoration(
                                  color: Colors.white,
                                  borderRadius: BorderRadius.circular(10),
